...
router.get("/getById/:id", (req,res) => recipeController.getById(req,res));
...
router.put("/update/:id", (req,res) => recipeController.update(req,res));
router.delete("/delete/:id", (req,res) => recipeController.deleteById(req,res));
